...
<% 
	try { 
		...
		String query = "SELECT MAX(num) FROM practice_board";
		...
		//게시글 db저장 코드
		String insertQuery = "INSERT INTO practice_board(num,title,writer,content,regdate) VALUES(?,?,?,?,?)";
		...
		//db저장 후 저장된 게시글이 반영된 목록보기 재요청 신호 보냄
