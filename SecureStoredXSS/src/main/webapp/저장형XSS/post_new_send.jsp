...
<%
	try {
		...
		String writer = filterXSS(request.getParameter("writer"));
		String title = filterXSS(request.getParameter("title"));
		String content = filterXSS(request.getParameter("content"));

		int num = 0;

		//저장된 게시글의 글번호중 가장 큰 값을 추출+1한 값을 현재글의 번호
