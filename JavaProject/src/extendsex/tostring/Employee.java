...
public class Employee {
	...
	// 클래스 인스턴스 출력코드나 출력과 관련된 코드인걸로 판정되면 객체를 문자열로 변경시켜주는 역할
	// 상속되어지는 메서드기 때문에 클래스 내용에 맞게 재정의 해서 사용
	
	//상속받은 메서드 재정의 의미 - Object 클래스로부터 자동상속됨
	//toString()메서드는 호출 없이 인스턴스가 출력과 관련된 코드에 사용되면 자동으로 호출됨
	@Override
