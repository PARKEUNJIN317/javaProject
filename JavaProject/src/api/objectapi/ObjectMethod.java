...
public class ObjectMethod {
	...
	public static void main(String[] args) {
		...
		//Object.toString() : 객체의 문자정보 리턴(하위클래스에서 재정의해서 개발자의도의 출력을 진행하도록함)
		...
		//System.gc() : Garbage Collector 호출, 바로 호출되지는 않고 메모리가 부족하거나 CPU가 한가할 때 JVM에 의해 실행
		//finalize() : 언제 호출될지 모름
