...
<html>
	...
	성명 : <jsp:getProperty property="stdName" name="studnt"/><br>
	전화 : <jsp:getProperty property="stdPhone" name="studnt"/><br>
	주소 : <jsp:getProperty property="stdAddress" name="studnt"/><br>
	학년 : <jsp:getProperty property="stdYear" name="studnt"/><br>
